...
def _read_jsonl(file: str) -> List[Dict]:
    ...
    # with open_jsonl(file) as f, open("data/scored-test-samples.jsonl", 'w') as output_file:
    #     for line in f:
    #         if line.strip():
    #             json_obj = json_loads(line)
...
def main():
    ...
    n_trials = 400
    # samples_path = "/storage/wangzijun/prm800k/prm800k/math_splits/test.jsonl"
